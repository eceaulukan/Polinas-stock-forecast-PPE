...
df = pd.read_excel("vending-machine.xlsx")
...
st.sidebar.image("otomat/vahit_work.png", use_column_width=True)


image_path = "otomat/200w.gif"
...
with st.sidebar:
    st.audio("otomat/SnapInsta.io - Legends Are Made (128 kbps).mp3", format="audio/mp3")
...
########################################################################################################################
    ...
    gif_path = "otomat/khaby-really.gif"
    ...
    if checkbox_value:
        ...
        gorsel = "otomat/1.jpg"
        timegorsel = "otomat/time.gif"
        gorsel = "otomat/vahit_worker.png"
        if secim == "Tahmin Türü Seç":
            st.image("otomat/tugce hoca.gif")
